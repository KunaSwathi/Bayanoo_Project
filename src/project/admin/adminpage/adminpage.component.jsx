        ...
        <div>
            ...
            <div className="row">
                <div className="col-sm-3">
                    <a href='/admin/admin-doctor' style={{textDecoration:'none'}}>
                ...
                <div className="col-sm-3">
                    <a href='/admin/admin-patient'  style={{textDecoration:'none'}}>
                ...
                <div className="col-sm-3">
                    <a href='/admin/admin-nurse'  style={{textDecoration:'none'}}>
                ...
                <div className="col-sm-3">
                    <a href='/admin/admin-pharmacist'  style={{textDecoration:'none'}}>
            ...
            <div className="row">
                <div className="col-sm-3">
                    <a href='/admin/admin-laboratorist'  style={{textDecoration:'none'}}>
                ...
                <div className="col-sm-3">
                    <a href='/admin/admin-accountant'  style={{textDecoration:'none'}}>
